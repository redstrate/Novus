...
const static QMap<QString, FileType> extensionToType{{QStringLiteral("exl"), FileType::ExcelList},
                                                     ...
                                                     {QStringLiteral("lcb"), FileType::LightClippingBinary},
                                                     {QStringLiteral("uwb"), FileType::UnderwaterBinary},
...
const static QMap<FileType, QString> typeToName{{FileType::Unknown, i18n("Unknown")},
                                                ...
                                                {FileType::UnderwaterBinary, i18n("Underwater Binary")},
...
const static QMap<FileType, std::function<const char *(Platform, physis_Buffer)>> typeToDebug{{FileType::LayerGroupBinary, physis_lgb_debug},
                                                                                              ...
                                                                                              {FileType::LightClippingBinary, physis_lcb_debug},
                                                                                              {FileType::UnderwaterBinary, physis_uwb_debug},
...
const static QMap<std::array<uint8_t, 4>, FileType> magicToType{
    ...
    {{0x20, 0x64, 0x67, 0x67}, FileType::GrassGridData},
    {{0x53, 0x56, 0x42, 0x31}, FileType::SkyVisibilityBinary},
    {{0x55, 0x57, 0x42, 0x31}, FileType::UnderwaterBinary},
    {{0x4C, 0x56, 0x42, 0x31}, FileType::LayerVariableBinary},
    {{0x4C, 0x43, 0x42, 0x31}, FileType::LightClippingBinary},
    {{0x41, 0x4D, 0x42, 0x00}, FileType::AmbientSet},
};
