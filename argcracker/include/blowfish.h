...
public:
    ...
    QByteArray Decrypt(QByteArray &data) {
        ...
        for (int i = 0; i < paddedLength; i += 8) {
            auto[L, R] = Decrypt(ToUint32((unsigned char *) buffer + i),
                                 ToUint32((unsigned char *) buffer + i + 4));
            CopyUInt32IntoArray((unsigned char *) buffer, L, i);
            CopyUInt32IntoArray((unsigned char *) buffer, R, i + 4);
        }
